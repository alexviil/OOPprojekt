...
public class Pawn extends Piece {
    ...
    public ArrayList<int[]> allPossibleMoves(Tile[][] board) {
        ...
        if (this.getColor()==1) {
            if (board[position[0]-1][position[1]].getCurrentPiece()==null) {
                possibleMoves.add(new int[]{position[0], position[1], position[0]-1, position[1]});
                if (board[position[0]-2][position[1]].getCurrentPiece()==null && position[0]==6) {
            ...
            if (board[position[0]+1][position[1]].getCurrentPiece()==null) {
                possibleMoves.add(new int[]{position[0], position[1], position[0]+1, position[1]});
                if (board[position[0]+2][position[1]].getCurrentPiece()==null && position[0]==1) {
                    possibleMoves.add(new int[]{position[0], position[1], position[0]+2, position[1]});
                }
            }
